COURSE_ACTS(COURSE_BOB, _("   FUZZ APARTMENT"),
       _("COLLECTING THE FUZZ")     , _("FOOTRACE WITH KOOPA THE QUICK") , _("SHOOT TO THE ISLAND IN THE SKY"),
...
CASTLE_SECRET_STARS(_("   SECRET NOMS"))

EXTRA_TEXT(0, _("ONE OF THE SECRET NOMS!"))
EXTRA_TEXT(1, _(""))
EXTRA_TEXT(2, _(""))
EXTRA_TEXT(3, _(""))
EXTRA_TEXT(4, _(""))
